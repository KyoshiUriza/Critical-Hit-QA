...
window.APP_DEFECTS = {
  login: {
    ...
    defects: [
      ...
      { id: "pw-length", severity: "medium", title: "Password minimum length not enforced", hint: "1-char password produces no format error" },
      ...
      { id: "password-persisted", severity: "critical", title: "Password stored in localStorage in plaintext", hint: "Remember-me stores remembered_pw key" }
    ]
  },
  todo: {
    name: "Todo List",
    ...
    defects: [
      ...
      { id: "no-persistence", severity: "high", title: "State does not persist across refresh", hint: "save() is a no-op" }
    ]
  },
  cart: {
    name: "Shopping Cart",
    ...
    defects: [
      ...
      { id: "empty-checkout", severity: "high", title: "Checkout succeeds with an empty cart", hint: "No empty-cart guard" },
  ...
  register: {
    ...
    defects: [
      ...
      { id: "email-regex", severity: "medium", title: "Email regex too permissive", hint: "a@b accepted" },
